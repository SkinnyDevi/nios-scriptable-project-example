import { config, Script, ListWidget, Color, Font, LinearGradient, Alert, Request, } from "nios-scriptable";
...
// CREATE YOUR WIDGETS
async function createWidget(data, widgetFamily = null) {
    ...
    if (SHOW_TEXT) {
        ...
        widget.backgroundGradient = newLinearGradient(["#ffffff00", "#ffffff00", "#00000088"], [0, 0.8, 1]);
